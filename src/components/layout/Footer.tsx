...
export async function Footer({ locale }: { locale: AppLocale }) {
  ...
  return (
    <footer className="section-border mt-24">
      <Container className="grid gap-10 py-12 lg:grid-cols-[1.2fr_0.8fr_0.8fr]">
        ...
        <div>
          <p className="text-xs uppercase tracking-[0.22em] text-secondary">Explore</p>
        ...
        <div>
          <p className="text-xs uppercase tracking-[0.22em] text-secondary">Contact</p>
      ...
      <Container className="border-t border-white/8 py-5 text-xs uppercase tracking-[0.18em] text-secondary">
